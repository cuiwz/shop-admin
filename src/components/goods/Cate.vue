<template>
  <div>
    ...
    <el-card>
      ...
      <!-- 表格 -->
      <!-- :data="catelist"绑定数据源 :columns="columns"设置列 :selection-type="false"关闭复选框 -->
      <!-- :expand-type="false"关闭展开行效果 show-index设置是否显示索引 index-text="#"设置索引标题名 -->
      <!-- border设置边框 :show-row-hover="false"取消鼠标悬浮高亮 -->
    ...
    <el-dialog title="添加分类" :visible.sync="addCateDialogVisible" width="50%" @close="addCateDialogClosed">
      ...
      <el-form :model="addCateForm" :rules="addCateFormRules" ref="addCateFormRef" label-width="100px">
        ...
        <el-form-item label="父级分类：">
          <!-- el-cascader 级联选择框 -->
          <!-- options用来指定数据源 props用来指定配置对象 @change="parentCateChanged"设置级联选择器改变触发事件 -->
          <!-- 级联选择器默认只能选择最后一级，前面的是选不到的，若需要选择任意一级属性，需要添加change-on-select属性 -->
